...
import { initialCanvasDraft, midElementCatalog } from '../data/canvasCatalog';
...
export function PrototypeProvider({ children }: { children: ReactNode }) {
  ...
  const value: PrototypeContextValue = {
    ...
    submitCanvas() {
      ...
      const message = 'Canvas draft submitted to processing.';
    ...
    submitUpload() {
      ...
      const message = 'Upload request submitted to processing.';
    ...
    setOrderStatus(status) {
      const message =
        status === 'confirmed'
          ? 'Draft confirmed. No real order was placed in this prototype.'
          : 'Changes requested. Please return to the source page and revise the draft.';
